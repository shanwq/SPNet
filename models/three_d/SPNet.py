...
class SPNet(nn.Module):
    ...
    def __init__(self, input_channels=1, base_num_features=32, num_classes=2, num_conv_per_stage=2,
        ...
        from .modeling.transformer_decoder.transformer_decoder3d import MultiScaleTransformerDecoder3d
        cfg = {
                    "num_classes": 2,
                    "hidden_dim": 192,
        ...
        self.predictor = MultiScaleTransformerDecoder3d(in_channels=max_hidden_dim, mask_classification=True, **cfg)
