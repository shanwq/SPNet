class hparams:
    ...
    ckpt_dir = '/memory/shanwenqi/Vessel_seg/IXI_MRA/45_cases/ICASSP/fold_%s/TransUnet/ckpt/checkpoint_0125.pt'%fold
    output_dir = '/memory/shanwenqi/Vessel_seg/IXI_MRA/45_cases/ICASSP/fold_%s/TransUnet/ckpt'%fold
    ...
    source_train_dir = '/memory/shanwenqi/Vessel_seg/IXI_MRA/45_cases/train/fold_%s/img_N4'%fold
    label_train_dir = '/memory/shanwenqi/Vessel_seg/IXI_MRA/45_cases/train/fold_%s/lbl_N4'%fold
    source_test_dir = '/memory/shanwenqi/Vessel_seg/IXI_MRA/45_cases/test/fold_%s/img_N4'%fold
    label_test_dir = '/memory/shanwenqi/Vessel_seg/IXI_MRA/45_cases/test/fold_%s/lbl_N4'%fold
    ...
    output_int_dir = '/memory/shanwenqi/Vessel_seg/IXI_MRA/45_cases/ICASSP/fold_%s/TransUnet/pred'%fold
